 ...
 * @subpackage Gobloo_Stripe_Connect/public
 */
 ...
 */
class Gobloo_Stripe_Connect_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/gobloo-stripe-connect-public.css', array(), $this->version, 'all' );
