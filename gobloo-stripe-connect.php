 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Gobloo Stripe Connect
 * Plugin URI:        https://github.com/glabstech/gobloo-stripe-connect
 ...
 * Text Domain:       gobloo-stripe-connect
 ...
 */
function deactivate_gobloo_stripe_connect() {
...
register_activation_hook( __FILE__, 'activate_gobloo_stripe_connect' );
register_deactivation_hook( __FILE__, 'deactivate_gobloo_stripe_connect' );
